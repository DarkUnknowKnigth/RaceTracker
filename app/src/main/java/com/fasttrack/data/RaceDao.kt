...
interface RaceDao {
    ...
    @Query("SELECT * FROM sessions WHERE userId = :userId AND vehicleId = :vehicleId ORDER BY startTime DESC")
    fun getSessionsByVehicle(userId: Int, vehicleId: Int): Flow<List<SessionEntity>>
